...
for label, disclose in (
    ...
    presentation = present(
        credential, disclose, nonce=nonce, audience=audience, holder_key=holder_key
    )
    seen = V.verify_presentation(
        presentation, expected_audience=audience, expected_nonce=nonce
    )
